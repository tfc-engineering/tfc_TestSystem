...
class WordIntegerCheck(CheckBase):
    '''Performs a check on a specific word of type int.'''
    @staticmethod
    def getInputParameters() -> InputParameters:
        ...
        params.addRequiredParam("word_number", ParameterType.INTEGER,
                                ...
                                "the gold value.")
        params.addRequiredParam("gold_value", ParameterType.INTEGER,
                                "The integer required to match.")
...
PyFactory.register(WordIntegerCheck, "WordIntegerCheck")
